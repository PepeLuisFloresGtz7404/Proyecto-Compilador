...
{
       0,    95,    95,    97,   101,   102,   103,   110,   111,   112,
     113,   114,   115,   116,   117
};
#endif
...
{
      -6,    13,    -6,    -6,    -4,    11,    -6,    11,    -6,    28,
      11,    -6,    -6,    20,    11,    11,    11,    11,    -6,    34,
      -6,    -2,    -2,    -6,    -6,    -6
};
...
{
      12,    10,    13,     0,     0,    19,    16,    17,     0,    21,
      22,    23,    24,     2,     3,    11,     3,     4,     5,     0,
       5,     0,     0,     7,     6,     7,    14,    15,    16,    17,
       0,     0,     0,    20,    14,    15,    16,    17,     0,    18,
      14,    15,    16,    17,     0,    25
};

static const yytype_int8 yycheck[] =
{
       5,     5,     7,    -1,    -1,    10,     8,     9,    -1,    14,
      15,    16,    17,     0,     3,     4,     3,     4,     7,    -1,
       7,    -1,    -1,    12,    11,    12,     6,     7,     8,     9,
...
{
       0,    15,     0,     3,     4,     7,    11,    12,    16,    17,
       5,     4,    17,    17,     6,     7,     8,     9,    11,    17,
      13,    17,    17,    17,    17,    11
};
...
#line 1134 "parser.tab.c"
  ...
  case 6: /* linea: ID ASIGNAR expresion '\n'  */
#line 103 "parser.y"
                               {
            asignar_valor((yyvsp[-3].id), (yyvsp[-1].num));
...
#line 1149 "parser.tab.c"
  ...
  case 8: /* expresion: ID  */
#line 111 "parser.y"
                          { (yyval.num) = obtener_valor((yyvsp[0].id)); }
...
#line 115 "parser.y"
                              { if ((yyvsp[0].num) == 0.0) { yyerror("division por cero"); (yyval.num) = 0.0; } else { (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); } }
